...
STATUS_TO_DESCRIPTION_MAP = {
    'create_booking': {
        'ok': '1C Connector бланк брони создан в 1С',
        'error': '1C Connector ошибка при создании бланка брони в 1С',
        'double': '1C Connector найден дубль бланка брони в 1С',
        'booking_error': '1C Connector время брони занято в 1С',
    },
    'delete_booking': {
        'ok': '1C Connector бланк брони удален в 1С',
        'error': '1C Connector ошибка при удалении бланка брони в 1С',
    },
    'create_stay': {
        'ok': '1C Connector бланк проживания создан в 1С',
        'error': '1C Connector ошибка связи с 1С при создании бланка проживания',
        'double': '1C Connector найден дубль бланка проживания в 1С',
    },
    'delete_stay': {
        'ok': '1C Connector бланк проживания удален в 1С',
        'error': '1C Connector ошибка при удалении бланка проживания в 1С',
    },
    'delete_all': {
        'ok': '1C Connector бланк брони и бланк проживания удалены в 1С',
        'error': '1C Connector ошибка при удалении бланка брони и проживания в 1С',
    }
}
